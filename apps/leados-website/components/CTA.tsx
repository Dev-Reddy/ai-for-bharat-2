    ...
    <section id="cta" className="w-full py-24 sm:py-32 relative overflow-hidden bg-white border-t border-border-subtle">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <a href="#" className="w-full sm:w-auto btn-primary px-8 py-4 text-base font-semibold shadow-xl shadow-blue-500/20 flex items-center justify-center gap-2">
            Try Demo Client Website <ArrowRight className="w-5 h-5" />
          </a>
          
          <div className="flex gap-2 w-full sm:w-auto justify-center">
            <a href="/admin" className="inline-flex h-14 items-center justify-center rounded-full bg-white border border-border-subtle px-6 text-sm font-semibold text-text-1 transition-all hover:bg-slate-50">
              <Lock className="w-4 h-4 mr-2 text-text-2" /> Open Admin Portal
            </a>
            <a href="/rm" className="inline-flex h-14 items-center justify-center rounded-full bg-white border border-border-subtle px-6 text-sm font-semibold text-text-1 transition-all hover:bg-slate-50">
