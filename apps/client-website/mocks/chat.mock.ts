export const mockChatResponses = {
  en: {
    greeting: (name: string) => `Hello ${name}, welcome to FinPartner Pro. I'm your AI assistant. How can I help you today?`,
  ...
  es: {
    greeting: (name: string) => `Hola ${name}, bienvenido a FinPartner Pro. Soy tu asistente de IA. ¿Cómo te puedo ayudar hoy?`,
